        ...
        <form className="space-y-2 md:space-y-4" onSubmit={handleSubmit(onSubmit)} noValidate>
          <div>
            ...
            <input type="text" name="name" id="name"
              ...
              placeholder="Enter Your Full Name" {...register("name",{ required:"Name Is Required!!",minLength: {value:
          ...
          <div>
            ...
            <input type="email" name="email" id="email"
              className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
              placeholder="example@gmail.com" {...register("email",{ required:"Email Is Required!!", pattern:{
          ...
          <div>
            ...
            <input type="text" id="studId"
              ...
              {...register("studId", { required: "This Field is Required ..." , pattern:{value:/[0-9]{9}/i,
          ...
          <div>
            ...
            <select id="year"
              className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
              {...register("year", { required: true })} defaultValue="Fourth Year">
