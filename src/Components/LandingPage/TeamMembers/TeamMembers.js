...
import DiveshAvatar from "./Divesh.png";
import AnkitaAvatar from "./Ankita.png";
import NavnathAvatar from "./Navnath.png";
import VaishnaviAvatar from "./Vaishnavi.png";
    ...
    <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
        ...
        <div className="grid gap-8 lg:gap-16 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4">
            <div className="text-center text-gray-500 dark:text-gray-400">
                <img className="mx-auto mb-4 w-36 h-36 rounded-full" src={DiveshAvatar} alt="Divesh Avatar" />
            ...
            <div className="text-center text-gray-500 dark:text-gray-400">
                <img className="mx-auto mb-4 w-36 h-36 rounded-full" src={VaishnaviAvatar} alt="Vaishnavi Avatar" />
                <h3 className="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                    <p>Vaishnavi Deore</p>
                </h3>
